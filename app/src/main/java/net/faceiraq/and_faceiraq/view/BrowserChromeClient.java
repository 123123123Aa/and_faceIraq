...
public class BrowserChromeClient extends WebChromeClient {
    ...
    private net.faceiraq.and_faceiraq.view.WebViewFragment.OnWebViewActionListener onWebViewActionListener;
    private PageDetails pageDetails;
    private String pageUrl;

    public BrowserChromeClient(net.faceiraq.and_faceiraq.view.WebViewFragment.OnWebViewActionListener onWebViewActionListener) {
